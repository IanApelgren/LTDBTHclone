 ...
 * @author Ian Apelgren
 * @author James Cooke
 * router settings will pull your ip address then plug it in to a browser to pull up ruter settings
 */


/**
 *houses all of the components for router settings
 */
public class RouterSettings extends javax.swing.JFrame {

    /**
     * Creates new form RouterSettings
     */
